!(function () {
    ...
    ao.formatPrefix = function (n, t) {
        var e = 0;
        return (
            (n = +n) && (0 > n && (n *= -1), t && (n = ao.round(n, Pn(n, t))), (e = 1 + Math.floor(1e-12 + Math.log(n) / Math.LN10)), (e = Math.max(-24, Math.min(24, 3 * Math.floor((e - 1) / 3))))),
            sa[8 + e / 3]
        );
    };
    var ha = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,
    ...
    (ao.interpolate = Mr),
        (ao.interpolators = [
            function (n, t) {
                var e = typeof t;
                return ("string" === e ? (ua.has(t.toLowerCase()) || /^(#|rgb\(|hsl\()/i.test(t) ? vr : mr) : t instanceof an ? vr : Array.isArray(t) ? xr : "object" === e && isNaN(t) ? dr : yr)(
                    n,
                    t
                );
            },
    ...
    ao.svg.brush = function () {
        ...
        function u() {
            ...
            if ((ao.event.changedTouches ? q.on("touchmove.brush", d).on("touchend.brush", m) : q.on("mousemove.brush", d).on("mouseup.brush", m), k.interrupt().selectAll("*").interrupt(), C))
    ...
    (ec.year = ga.year.utc),
        ...
        "function" == typeof define && define.amd ? ((this.d3 = ao), define(ao)) : "object" == typeof module && module.exports ? (module.exports = ao) : (this.d3v3 = ao);
})();
